...
<template>
  ...
  <div class="flex justify-center mx-auto my-10">
    <div class="relative w-full lg:w-3/4">
      <img :src="news[4].thumb5" alt="" class="">
      ...
      <div class="relative lg:absolute lg:bottom-8 lg:left-10 text-center w-full lg:text-left lg:w-3/4 p-5 lg:p-0">
        <h3 class="text-3xl text-primaryRed mt-6 lg:text-white"> {{ news[4].title }}</h3>
        <p class="text-lightBlack lg:text-white font-semibold text-sm mb-8 mt-4 md:mb-0">
          {{ news[4].description }}
        </p>
        <router-link :to="news[4].link" class="mx-auto text-center">
          <button
