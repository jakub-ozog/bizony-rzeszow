...
import postMainThumb from '@/assets/images/galleries/gallery-6/11.webp'
</script>

<template>
  <section class="container mx-auto text-left my-12 font-urbanist">
    <h1 class="text-5xl font-bold text-primaryRed">Wiosenne słońce, pierwsze zwycięstwo. Relacja z dwumeczu
    ...
    <div class="flex flex-row gap-6 mt-2 mb-12">
      ...
      <div class="flex flex-row gap-2 items-center">
        ...
        <p class="text-sm text-gray-500">22.03.2025</p>
      </div>
    </div>
    ...
    <p class="font-base text-lg mt-8">
      ...
      zawodnicy zajęli wszystkie bazy, mając realną szansę na wyrównanie. Wtedy jednak błysnął Jakub Olszowy, który
      złapał odbicie na zapolu z powietrza, uniemożliwiając rywalom większe zdobycze punktowe. Ostatecznie Opolanie
    ...
    <p class="font-base text-lg mt-8">
      ...
      także
      na cztery zmiany wśród pałkarzy z podstawowego zestawienia. Efekt? Pojedynek, w którym atak miał zdecydowanie
      więcej
    ...
    <p class="font-base text-lg mt-8">
      ...
      rewanż
      zakończył się zwycięstwem Wizards 15:11
    </p>
    ...
    <p class="font-base text-xl mt-6">
      ...
      LF – Wodzisz<br>
      RF – Miciuda<br>
      P – Barczyk, Nicolas, Jurczyński<br>
    </p>
