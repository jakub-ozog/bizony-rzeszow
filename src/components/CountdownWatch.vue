...
<template>
  ...
  <div class=" mx-auto flex flex-col justify-center items-center">
    ...
    <div class="flex items-center justify-center gap-8 mt-8  w-[300px]">
      <div class="flex flex-col items-center text-white">
        <p class="text-5xl font-bold text-white  w-[38px]">{{ countdown.days }}</p>
        <p class="text-sm font-light text-white">dni</p>
      </div>
      <p class="text-white text-2xl font-bold">:</p>
      <div class="flex flex-col items-center">
        <p class="text-5xl font-bold text-white  w-[38px]"> {{ countdown.hours }}</p>
        <p class="text-sm font-light text-white">godzin</p>
      </div>
      <p class="text-white text-2xl font-bold">:</p>
      <div class="flex flex-col items-center">
        <p class="text-5xl font-bold text-white  w-[38px]">{{ countdown.minutes }}</p>
        <p class="text-sm font-light text-white">minut</p>
      </div>
      <p class="text-white text-2xl font-bold">:</p>
      <div class="flex flex-col items-center">
        <p class="text-5xl font-bold text-white  w-[38px]">{{ countdown.seconds }}</p>
